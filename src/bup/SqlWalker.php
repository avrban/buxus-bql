                    ...
                    foreach ($curPageType->properties as $curProperty) {
                        if (!$curProperty->isColumn) {
                            if($curProperty->class_id==C_ppc_Extended) {
                                ...
                                /*linked properties*/
                                $this->sqlQuery->fromClause .= " JOIN tblLinkProperties ppv_" . $curProperty->pageTypeAlias .
                                    " ON ( ppv_" . $curProperty->pageTypeAlias . ".from_page_id = " . $curPageType->aliasPrefix . ".page_id" .
                                    " AND ppv_" . $curProperty->pageTypeAlias . ".property_id = " . $curProperty->id .
                                    " )";
                            }
                        }
